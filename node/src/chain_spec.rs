...
use parachain_template_runtime::{AccountId, AuraId, Signature, ChainlinkFeedConfig, EXISTENTIAL_DEPOSIT, SudoConfig};
...
fn testnet_genesis(
	...
	parachain_template_runtime::GenesisConfig {
		...
		chainlink_feed: ChainlinkFeedConfig {
			pallet_admin: Some(get_account_id_from_seed::<sr25519::Public>("Alice")),
